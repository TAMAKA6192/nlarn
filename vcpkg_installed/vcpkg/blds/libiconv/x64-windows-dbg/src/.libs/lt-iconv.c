...
const char * LIB_PATH_VALUE   = "D:\\ReposGitHub\\nLARN\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\ReposGitHub\\nLARN\\vcpkg_installed\\x64-windows\\debug\\lib;";
const char * EXE_PATH_VARNAME = "PATH";
const char * EXE_PATH_VALUE   = "D:\\ReposGitHub\\nLARN\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\ReposGitHub\\nLARN\\vcpkg_installed\\x64-windows\\debug\\lib;D:\\ReposGitHub\\nLARN\\vcpkg_installed\\vcpkg\\pkgs\\libiconv_x64-windows\\D\\ReposGitHub\\nLARN\\vcpkg_installed\\x64-windows\\debug\\bin;";
...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("  notinst_deplibs=' /D/ReposGitHub/nLARN/vcpkg_installed/vcpkg/pkgs/libiconv_x6", f);
  fputs ("4-windows/D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/debug/lib/libiconv.la", f);
  fputs ("'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("    echo \"iconv.exe:iconv:$LINENO: libtool wrapper (GNU libtool) 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("    PATH=/D/ReposGitHub/nLARN/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/D", f);
  fputs ("/ReposGitHub/nLARN/vcpkg_installed/x64-windows/debug/lib:/D/ReposGitHub/nLARN/v", f);
  fputs ("cpkg_installed/vcpkg/pkgs/libiconv_x64-windows/D/ReposGitHub/nLARN/vcpkg_instal", f);
  fputs ("led/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/D/ReposGitHub/nLARN/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/", f);
  fputs ("D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/debug/lib:$PATH\"\n", f);
  fputs ("\n", f);
