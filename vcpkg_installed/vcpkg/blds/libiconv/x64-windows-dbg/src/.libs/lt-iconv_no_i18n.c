...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    echo \"iconv_no_i18n.exe:iconv_no_i18n:$LINENO: libtool wrapper (GNU libtool", f);
  fputs (") 2.5.4\" 1>&2\n", f);
  fputs ("  fi\n", f);
  fputs ("}\n", f);
  fputs ("\n", f);
  ...
  fputs ("  for lt_arg\n", f);
  fputs ("  do\n", f);
  fputs ("    $ECHO \"iconv_no_i18n.exe:iconv_no_i18n:$LINENO: newargv[$lt_dump_args_N]: $", f);
  fputs ("lt_arg\"\n", f);
  ...
  fputs ("\n", f);
  fputs ("      if test -n \"$lt_option_debug\"; then\n", f);
  fputs ("        $ECHO \"iconv_no_i18n.exe:iconv_no_i18n:$LINENO: newargv[0]: $progdir\\\\$", f);
  fputs ("program\" 1>&2\n", f);
  ...
  fputs ("    PATH=/d/ReposGitHub/nLARN/vcpkg_installed/vcpkg/blds/libiconv/x64-windows-d", f);
  fputs ("bg/lib/.libs:/D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/debug/lib:/D/Repo", f);
  fputs ("sGitHub/nLARN/vcpkg_installed/x64-windows/debug/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/ReposGitHub/nLARN/vcpkg_installed/vcpkg/blds/libiconv/x64-windows-", f);
  fputs ("dbg/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
