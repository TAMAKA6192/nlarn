...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("    PATH=/d/ReposGitHub/nLARN/vcpkg_installed/vcpkg/blds/libiconv/x64-windows-r", f);
  fputs ("el/lib/.libs:/D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/lib:/D/ReposGitHu", f);
  fputs ("b/nLARN/vcpkg_installed/x64-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/d/ReposGitHub/nLARN/vcpkg_installed/vcpkg/blds/libiconv/x64-windows-", f);
  fputs ("rel/lib/.libs:$PATH\"\n", f);
  fputs ("\n", f);
