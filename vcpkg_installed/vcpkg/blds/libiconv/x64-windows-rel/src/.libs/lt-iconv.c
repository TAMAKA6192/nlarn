...
void lt_dump_script (FILE* f)
{
  ...
  fputs ("4-windows/D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/lib/libiconv.la'\n", f);
  fputs ("else\n", f);
  ...
  fputs ("/ReposGitHub/nLARN/vcpkg_installed/x64-windows/lib:/D/ReposGitHub/nLARN/vcpkg_i", f);
  fputs ("nstalled/vcpkg/pkgs/libiconv_x64-windows/D/ReposGitHub/nLARN/vcpkg_installed/x6", f);
  fputs ("4-windows/bin:$PATH\n", f);
  fputs ("\n", f);
  fputs ("    # Add our own library path to PATH\n", f);
  fputs ("    PATH=\"/D/ReposGitHub/nLARN/vcpkg_installed/vcpkg/pkgs/libiconv_x64-windows/", f);
  fputs ("D/ReposGitHub/nLARN/vcpkg_installed/x64-windows/lib:$PATH\"\n", f);
  fputs ("\n", f);
